...
class page_employeemovement extends \xepan\base\Page{
	...
	function init(){
		...
		$grid->js('click')->_selector('.do-view-employee-movement')->univ()->frameURL('Employee Movements',[$this->api->url('xepan_hr_movementdetail'),'employee_id'=>$this->js()->_selectorThis()->closest('[data-id]')->data('id')]);
	}
}
