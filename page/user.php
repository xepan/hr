...
class page_user extends \xepan\base\Page{
	...
	function init(){
		...
		$user_view->setModel($user_m,array('created_by_id','username','password','type','scope','status'),array('username','type','status','action','related_contact','related_contact_type'));
