...
class page_configurationsidebar extends \xepan\base\Page{
	function init(){
		...
		$this->app->side_menu->addItem(['Leave Template','icon'=>'fa fa-file-o'],'xepan_hr_leavetemplate')->setAttr(['title'=>'Leave Template']);
		$this->app->side_menu->addItem(['Salary Template','icon'=>'fa fa-file-o'],'xepan_hr_salarytemplate')->setAttr(['title'=>'Salary Template']);
